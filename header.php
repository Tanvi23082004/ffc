...
<body>
  ...
  <a class="navbar-brand" href="index.php"><img src="images/logo.png" alt="Cloud Kitchen Logo" style="height: 4.5rem;"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto pr-5">
      ...
      <li class="nav-item">
        <a class="nav-link" href="alogin.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
        Admin
        </a>
      </li>
    </ul>
